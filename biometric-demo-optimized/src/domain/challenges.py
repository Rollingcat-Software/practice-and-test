...
class ChallengeThresholds:
    ...
    EAR (Eye Aspect Ratio) tuning notes:
    - Natural blink EAR drops to ~0.10-0.15
    - Open eye EAR is typically 0.25-0.35
    - Wider gap prevents flickering at threshold boundary
    """
    EAR_OPEN = 0.22          # Above this = eye definitely open
    EAR_CLOSED = 0.16        # Must go BELOW this = eye definitely closed
    ...
    EYEBROW_BOTH = 1.12      # Both eyebrows ratio
    EYEBROW_SINGLE = 1.15    # Single eyebrow raise
