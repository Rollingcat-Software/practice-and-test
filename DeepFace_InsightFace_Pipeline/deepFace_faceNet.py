...
try:
    ...
    # With model_name='Facenet' we specify which face recognition model to use.
    result_same_person = DeepFace.verify(
        img1_path="../../../../PycharmProjects/face_verification/test_images/aysenur_tc.jpg",
        img2_path="../../../../PycharmProjects/face_verification/images/aysenur.jpg",
        model_name="Facenet"
    )
    print("\nComparing aysenur_tc.jpg with aysenur.jpg:")
...
try:
    ...
    # The returned result is a list that contains a dictionary.
